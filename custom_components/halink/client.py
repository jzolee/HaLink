...
class TcpClient:
    ...
    def __init__(
        ...
        self._start_listener_remover: Optional[Callable] = None
    ...
    async def stop(self) -> None:
        ...
        # Távolítsuk el az eseményfigyelőt, ha még nem futott le
        if self._start_listener_remover:
            try:
                self._start_listener_remover()
            except Exception:
                pass
            self._start_listener_remover = None
    ...
    def schedule_start(self) -> None:
        ...
        self._start_listener_remover = self.hass.bus.async_listen_once(
            EVENT_HOMEASSISTANT_STARTED, _start_later
        )
